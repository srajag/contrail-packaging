#! /bin/bash
##
## The script is based on tools/packaging/common/control_files/vrouter-pre-start.sh
##
## For vRouter/DPDK we have to configure VGW after vRouter/DPDK
## has started, hence it is post-start script now.
##
